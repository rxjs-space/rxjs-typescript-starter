...
export const GET_ALL: ActionType[] = [ GET_ALL_START, GET_ALL_COMPLETE, GET_ALL_FAIL ];
...
export const GET_ONE: ActionType[] = [ GET_ONE_START, GET_ONE_COMPLETE, GET_ONE_FAIL ];
...
export const ADD_ITEM: ActionType[] = [ ADD_ITEM_START, ADD_ITEM_COMPLETE, ADD_ITEM_FAIL ];
...
export const DELETE_ITEM: ActionType[] = [ DELETE_ITEM_START, DELETE_ITEM_COMPLETE, DELETE_ITEM_FAIL ];
...
export const EDIT_ITEM_SAVE: ActionType[] = [ EDIT_ITEM_SAVE_START, EDIT_ITEM_SAVE_COMPLETE, EDIT_ITEM_SAVE_FAIL ];
